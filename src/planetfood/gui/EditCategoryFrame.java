...
public class EditCategoryFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CAREGORY EDIT PANEL");
        ...
        TxtCategoryCode.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(TxtCategoryCode, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel3)
                .addGap(18, 18, 18)
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/planetfood/gui/edit employee 3.png"))); // NOI18N
    ...
    private void BtnAddProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAddProductActionPerformed
        if(validateInput() == false) {
            ...
            try {
                ...
                String CategoryId = TxtCategoryCode.getText();
           e.setCat_id(CategoryId);
                String Category = ComboBoxCategory.getSelectedItem().toString();
               e.setCat_Name(Category);

                if(Categorydao.updateCategory(e))
...
private boolean validateInput(){
        if (TxtCategoryCode.getText().isEmpty())
            return false;
        else
            return true;
}
